...
% Bowen Xiao 20251211
% testing recovy for ehgf-ddm in tapas
...
% 
bopars = tapas_fitModel([], u,...
        prc_config,...
        'tapas_bayes_optimal_binary_config',...
        'tapas_quasinewton_optim_config');
disp('Setting priors with bopars...')
prc_config.p_prc.om(2) = bopars.p_prc.om(2);
prc_config.p_prc.om(3) = bopars.p_prc.om(3);
...
pal_tapas_plotParRecAll(sims_valid, fitted_valid, ...
  {'p_prc.om(2)','p_prc.om(3)','p_obs.p(1)', 'p_obs.p(2)','p_obs.p(3)', 'p_obs.p(4)','p_obs.p(5)'}, ...
  {'omega2','omega3','v', 'a','z','ndt','v0'});
