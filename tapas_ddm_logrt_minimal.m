function [logp, yhat, res] = tapas_ddm_logrt_minimal(r, infStates, ptrans)
...
for iTrial = 1:ntrials
    ...
    p0(iTrial) = tapas_wiener_pdlogrt(logrt(iTrial), alpha, tau, beta, drift_rate(iTrial));
    p1(iTrial) = tapas_wiener_pdlogrt(logrt(iTrial), alpha, tau, 1-beta, -drift_rate(iTrial));
end
