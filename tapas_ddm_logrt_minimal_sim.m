function y = tapas_ddm_logrt_minimal_sim(r, infStates, p)
% Simulate choice and RT for tapas_ddm_logrt_minimal
...
ddm_sim_opts.dt = 0.001; %0.1ms for extra precision

% unpack params
drift_scaling = p(1); % multiplies to infState
alpha = p(2); %boundary separation
...
% simulate
y = tapas_wiener_gen_logrt(alpha, tau, beta, drift_rate, ddm_sim_opts);
