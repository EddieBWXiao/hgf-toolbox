function [p, log_prob] = wiener_pdlogrt(logrt, alpha, tau, beta, delta, varargin)
...
%            see wiener_pdrts for more details
% 
% INPUT:
% - logrt: MUST be in log milliseconds (consistent with other logrt hgf-toolbox functions)
% - For other inputs, see wiener_pdrts; varargin enables complete wrapping
%   
% --------------------------------------------------------------------------------------------------
% Copyright (C) 2025 Bowen Xiao 2025 University of Cambridge
% wrapper around wiener_pdrts to handle log reaction time data
...
p_linear = wiener_pdrts(rt, alpha, tau, beta, delta, varargin{:});
