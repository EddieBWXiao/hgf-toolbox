function [logp, yhat, res] = ddm_logrt_pwrbp(r, infStates, ptrans)
...
for iTrial = 1:ntrials
    ...
    p0(iTrial) = wiener_pdlogrt(logrt(iTrial), alpha(iTrial), tau, beta, drift_rate(iTrial));
    p1(iTrial) = wiener_pdlogrt(logrt(iTrial), alpha(iTrial), tau, 1-beta, -drift_rate(iTrial));
end
